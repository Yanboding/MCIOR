...
class Memory(object):
    def __init__(self, state_dim, action_dim, action_num, max_size=int(1e6)):
        ...
        self.action_mask = np.zeros((max_size,action_num))
    ...
    def add(self, state, action, action_mask, next_state, reward, done):
    ...
    def sample(self):
        ...
        return (
            ...
            torch.tensor(self.action_mask[:self.ptr]).to(self.device),
